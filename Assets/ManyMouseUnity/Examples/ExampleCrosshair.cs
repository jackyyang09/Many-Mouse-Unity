...
{
    public class ExampleCrosshair : MonoBehaviour
    {
        ...
        /// <summary>
        /// There's many ways you can extend this code to get the "true mouse position" based 
        ...
        /// 
        /// Getting the true mouse position would involve getting the size and position of the game 
        /// window relative to the rest of the screen and multiplying the mouse position based on those 
        /// values
        /// </summary>
