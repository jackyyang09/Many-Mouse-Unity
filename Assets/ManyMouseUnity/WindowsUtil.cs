...
public class WindowsUtil
{
    ...
    public static UnityEngine.Rect GetWindowPosition()
    {
        System.Diagnostics.Process process = System.Diagnostics.Process.GetCurrentProcess();
        process.Refresh();
        ...
        EnumWindows(delegate (System.IntPtr wnd, System.IntPtr param)
        {
            ...
            if (id == process.Id)
            {
                GetWindowRect(wnd, ref rectangle);
                return false;
            }

            return true;
        }, System.IntPtr.Zero);
        return new UnityEngine.Rect(rectangle.Left, rectangle.Top, rectangle.Right - rectangle.Left, rectangle.Bottom - rectangle.Top);
    }
}
